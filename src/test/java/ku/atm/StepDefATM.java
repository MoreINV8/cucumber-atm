...
public class StepDefATM {
    ...
    public void i_deposit_positive_amount(double depositAmount) {
        try {
            atm.deposit(depositAmount);
        } catch (DepositNegativeValueException e) {
            throw new RuntimeException(e);
        }
    }

    @When("I deposit negative value {double} to ATM")
    public void i_deposit_negative_amount(double depositAmount) {
        assertThrows(DepositNegativeValueException.class, () -> atm.deposit(depositAmount));
    }
}
